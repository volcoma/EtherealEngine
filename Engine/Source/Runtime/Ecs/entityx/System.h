...
namespace entityx 
{
	...
	public:
		 ...
		 */
		virtual void frameBegin(EntityManager &entities, EventManager &events, TimeDelta dt) = 0;
		virtual void frameUpdate(EntityManager &entities, EventManager &events, TimeDelta dt) = 0;
		virtual void frameRender(EntityManager &entities, EventManager &events, TimeDelta dt) = 0;
		virtual void frameEnd(EntityManager &entities, EventManager &events, TimeDelta dt) = 0;
	...
	public:
		...
		virtual void frameUpdate(EntityManager &entities, EventManager &events, TimeDelta dt) {}
		virtual void frameRender(EntityManager &entities, EventManager &events, TimeDelta dt) {}
		virtual void frameEnd(EntityManager &entities, EventManager &events, TimeDelta dt) {}
	...
	public:
		...
		void update(TimeDelta dt) 
		{
			...
			s->frameUpdate(entity_manager_, event_manager_, dt);
		}
		 ...
		 */
		void frameBegin(TimeDelta dt);
		void frameUpdate(TimeDelta dt);
		void frameRender(TimeDelta dt);
		void frameEnd(TimeDelta dt);
		/**
