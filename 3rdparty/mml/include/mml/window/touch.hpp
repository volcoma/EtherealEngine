#ifndef MML_TOUCH_HPP
#define MML_TOUCH_HPP
...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    static bool is_down(unsigned int finger);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static std::array<std::int32_t, 2> get_position(unsigned int finger);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static std::array<std::int32_t, 2> get_position(unsigned int finger, const window& relativeTo);
};
...
/// \ingroup window
///
/// mml::touch provides an interface to the state of the
...
/// its events. Compared to the touch_began, touch_moved
/// and touch_ended events, mml::touch can retrieve the
...
///
/// The get_position function can be used to retrieve the current
...
/// Usage example:
/// \code
/// if (mml::touch::is_down(0))
/// {
///     // touch 0 is down
/// }
///
/// // get global position of touch 1
/// mml::std::array<std::int32_t, 2> globalPos = mml::touch::get_position(1);
///
/// // get position of touch 1 relative to a window
/// mml::std::array<std::int32_t, 2> relativePos = mml::touch::get_position(1, window);
/// \endcode
///
/// \see mml::joystick, mml::keyboard, mml::mouse
///
////////////////////////////////////////////////////////////
