...
namespace ImGui
{
	...
	IMGUI_API int ImageButtonWithAspectAndLabel(ImTextureID texture, ImVec2 texture_size, ImVec2 size, ImVec2 uv0, ImVec2 uv1, bool selected, const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0);
