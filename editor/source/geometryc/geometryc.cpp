...
#include "graphics/tinystl/allocator.h"
#include "graphics/tinystl/unordered_map.h"
#include "graphics/tinystl/unordered_set.h"
...
typedef std::vector<Grp> GroupArray;
...
{
	bool operator()(const Grp& _lhs, const Grp& _rhs)
	{
