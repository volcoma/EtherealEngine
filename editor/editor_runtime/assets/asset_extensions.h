...
inline const std::vector<std::vector<std::string>>& get_all_formats()
{
    static const std::vector<std::vector<std::string>> types = {
		ex::get_suported_formats<gfx::texture>(),   ex::get_suported_formats<mesh>(),
		ex::get_suported_formats<runtime::animation>(), ex::get_suported_formats<audio::sound>(),
		ex::get_suported_formats<gfx::shader>(),	ex::get_suported_formats<material>(),
		ex::get_suported_formats<prefab>(),	ex::get_suported_formats<scene>()};
