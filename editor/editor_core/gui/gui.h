...
bool ImageButton(std::shared_ptr<void> texture, const ImVec2& _size,
				 const ImVec2& _uv0 = ImVec2(0.0f, 0.0f), const ImVec2& _uv1 = ImVec2(1.0f, 1.0f),
...
void ImageWithAspect(std::shared_ptr<void> texture, const ImVec2& texture_size, const ImVec2& size,
					 const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1),
					 const ImVec4& tint_col = ImVec4(1, 1, 1, 1),
					 const ImVec4& border_col = ImVec4(0, 0, 0, 0));

int ImageButtonWithAspectAndLabel(std::shared_ptr<void> texture, const ImVec2& texture_size,
