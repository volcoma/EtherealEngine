...
spherical_triangle_mesh_t::spherical_triangle_mesh_t(double radius, int segments)
	: spherical_triangle_mesh_t{gml::dvec3{radius, 0.0, 0.0}, gml::dvec3{0.0, radius, 0.0},
								gml::dvec3{0.0, 0.0, radius}, segments}
{
}

spherical_triangle_mesh_t::spherical_triangle_mesh_t(const gml::dvec3& v0, const gml::dvec3& v1,
													 const gml::dvec3& v2, int segments)
	: v0_{v0}
	, v1_{v1}
	, v2_{v2}
