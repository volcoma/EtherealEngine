...
REFLECT(light)
{
	rttr::registration::class_<light::spot>("spot")
		.property("range", &light::spot::get_range, &light::spot::set_range)(
			rttr::metadata("pretty_name", "Range"), rttr::metadata("min", 0.1f))
		.property("inner_angle", &light::spot::get_inner_angle, &light::spot::set_inner_angle)(
			rttr::metadata("pretty_name", "Inner Angle"), rttr::metadata("min", 1.0f),
			rttr::metadata("max", 85.0f), rttr::metadata("step", 0.1f))
		.property("outer_angle", &light::spot::get_outer_angle, &light::spot::set_outer_angle)(
			rttr::metadata("pretty_name", "Outer Angle"), rttr::metadata("min", 1.0f),
			rttr::metadata("max", 90.0f), rttr::metadata("step", 0.1f));
	...
	rttr::registration::class_<light::point>("point")
		...
		.property("exponent_falloff",
				  &light::point::exponent_falloff)(rttr::metadata("pretty_name", "Exponent Falloff"),
												   rttr::metadata("min", 0.1f), rttr::metadata("max", 10.0f))
		.property("fovx_adjust", &light::point::fov_x_adjust)(
			rttr::metadata("pretty_name", "FovX Adjust"), rttr::metadata("min", -20.0f),
			rttr::metadata("max", 20.0f), rttr::metadata("step", 0.0001f))
		.property("fovy_adjust", &light::point::fov_y_adjust)(
			rttr::metadata("pretty_name", "FovY Adjust"), rttr::metadata("min", -20.0f),
			rttr::metadata("max", 20.0f), rttr::metadata("step", 0.0001f))
	...
	rttr::registration::class_<light::directional>("directional")
		.property("splits", &light::directional::num_splits)(
			rttr::metadata("pretty_name", "Splits"), rttr::metadata("min", 1), rttr::metadata("max", 4))
		.property("distribution", &light::directional::split_distribution)(
			rttr::metadata("pretty_name", "Distribution"), rttr::metadata("min", 0.0f),
			rttr::metadata("max", 1.0f), rttr::metadata("step", 0.001f))
	...
	rttr::registration::enumeration<light_type>("light_type")(
		rttr::value("spot", light_type::spot), rttr::value("point", light_type::point),
	...
	rttr::registration::enumeration<shadow_type>("shadow_type")(
		rttr::value("hard", shadow_type::hard), rttr::value("pcf", shadow_type::pcf),
		rttr::value("vsm", shadow_type::vsm), rttr::value("esm", shadow_type::esm));
	rttr::registration::class_<light>("light")
		...
		.property("intensity", &light::intensity)(rttr::metadata("pretty_name", "Intensity"),
												  rttr::metadata("min", 0.0f), rttr::metadata("max", 20.0f))
