	...
	bool asset_manager::initialize()
	{
		...
		}
		{
			...
			}
			{
				...
				auto instance = std::make_shared<mesh>();
				instance->create_cube(gfx::mesh_vertex::decl, 1.0f, 1.0f, 1.0f, 1, 1, 1, false, mesh_create_origin::center);
				load_asset_from_instance(id, instance);
			}
			{
				const auto id = "embedded:/plane";
				auto instance = std::make_shared<mesh>();
				instance->create_cube(gfx::mesh_vertex::decl, 10.0f, 0.01f, 10.0f, 1, 1, 1, false, mesh_create_origin::center);
				load_asset_from_instance(id, instance);
			}
			{
				const auto id = "embedded:/cylinder";
				auto instance = std::make_shared<mesh>();
				instance->create_cylinder(gfx::mesh_vertex::decl, 0.5f, 2.0f, 20, 20, false, mesh_create_origin::center);
				load_asset_from_instance(id, instance);
			}
			{
				const auto id = "embedded:/capsule";
				auto instance = std::make_shared<mesh>();
				instance->create_capsule(gfx::mesh_vertex::decl, 0.5f, 2.0f, 20, 20, false, mesh_create_origin::center);
				load_asset_from_instance(id, instance);
			}
			{
				const auto id = "embedded:/cone";
				auto instance = std::make_shared<mesh>();
				instance->create_cone(gfx::mesh_vertex::decl, 0.5f, 0.0f, 2, 20, 20, false, mesh_create_origin::bottom);
				load_asset_from_instance(id, instance);
			}
			{
				const auto id = "embedded:/torus";
				auto instance = std::make_shared<mesh>();
				instance->create_torus(gfx::mesh_vertex::decl, 1.0f, 0.5f, 20, 20, false, mesh_create_origin::center);
				load_asset_from_instance(id, instance);
			}
			{
