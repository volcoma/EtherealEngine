...
public:
	...
	{
        constexpr static const char alphabet_upper[] = "0123456789ABCDEF";
        constexpr static const char alphabet_lower[] = "0123456789abcdef";

        const char* alphabet = uppercase ? alphabet_upper : alphabet_lower;
		// print hex
		int k = 0;
		for(int i = 0; i < 5; i++)
		{
