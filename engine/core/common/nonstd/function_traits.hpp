...
constexpr inline auto apply_(F&& f, T&& t, index_sequence<I...>) noexcept(
	...
	-> decltype(invoke_(std::forward<F>(f), std::get<I>(std::forward<T>(t))...))
{
...
constexpr inline auto apply(F&& f, T&& t) noexcept(
	noexcept(detail::apply_(std::forward<F>(f), std::forward<T>(t),
							make_index_sequence<std::tuple_size<typename std::decay<T>::type>::value>{})))
	-> decltype(detail::apply_(std::forward<F>(f), std::forward<T>(t),
							   make_index_sequence<std::tuple_size<typename std::decay<T>::type>::value>{}))
{
