...
public:
    ...
    void poll_entry(const fs::path& path,
                    std::vector<filesystem_watcher::entry>& modifications,
                    std::vector<size_t>& created,
                    std::vector<size_t>& modified)
    {
...
auto filesystem_watcher::watch(const fs::path& path,
                               bool recursive,
                               bool initial_list,
                               clock_t::duration poll_interval,
...
auto filesystem_watcher::watch_impl(const fs::path& path,
                                    bool recursive,
                                    bool initial_list,
                                    clock_t::duration poll_interval,
