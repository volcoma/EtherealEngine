...
// Define NONSTD_OPTIONAL_MEMBERS_REF_QUALIFIERS to get lvalue- and rvalue-qualified members
...
namespace nonstd {
	...
	private:
		...
		static void swap_helper(optional& from, optional& to) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_move_constructible<T>::value &&
	...
	public:
		...
		_NONSTD_OPT_CONSTEXPR optional() _NONSTD_OPT_NOEXCEPT
			: stg_(), pval_(reinterpret_cast<T*>(&stg_)), has_value_(false) { }
		_NONSTD_OPT_CONSTEXPR optional(nullopt_t) _NONSTD_OPT_NOEXCEPT
			: stg_(), pval_(reinterpret_cast<T*>(&stg_)), has_value_(false) { }
		...
		template<typename U, typename... Args,
			...
			_NONSTD_OPT_CONSTEXPR explicit optional(in_place_t,
		...
		optional& operator=(const optional& obj) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_copy_constructible<T>::value &&
		...
		optional& operator=(optional&& obj) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_move_constructible<T>::value &&
		...
		template<typename U,
			...
			_NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_constructible<T, U>::value &&
		...
		_NONSTD_OPT_CONSTEXPR T value_or(U&& default_val) const _NONSTD_OPT_LVALUE_REF_QUALIF
			_NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_copy_constructible<T>::value &&
		...
		_NONSTD_OPT_CONSTEXPR T value_or(U&& default_val) &&
			_NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_move_constructible<T>::value &&
				std::is_nothrow_constructible<T, U>::value)
		{
		...
		// Swap implementation
		void swap(optional& obj) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_move_constructible<T>::value &&
			std::is_nothrow_destructible<T>::value &&
		...
		template<typename... Args>
		void emplace(Args&&... args) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_destructible<T>::value &&
		...
		template<typename U, typename... Args,
			...
			void emplace(std::initializer_list<U> ilist,
				Args&&... args) _NONSTD_OPT_NOEXCEPTEX(std::is_nothrow_destructible<T>::value &&
	...
	template<typename T>
	_NONSTD_OPT_CONSTEXPR auto make_optional(T&& val)
	...
	_NONSTD_OPT_CONSTEXPR auto make_optional(Args&&... args)
		-> optional<T>
	{
		return optional<T>(in_place, std::forward<Args>(args)...);
	}
	template<typename T, typename U, typename... Args>
	_NONSTD_OPT_CONSTEXPR auto make_optional(std::initializer_list<U> ilist, Args&&... args)
		-> optional<T>
	{
